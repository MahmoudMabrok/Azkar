...
public class Night extends AppCompatActivity {
  ...
  ScrollView touch2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final     String s[]=getResources().getStringArray(R.array.night);
        ...
        button_mave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (p_count<s.length+1) {
                    ...
                    Toast.makeText(Night.this, "لقد انتهيت", Toast.LENGTH_SHORT).show();
                }
                x_move=x_move+1;
                if(x_move<s.length)
                {
    ...
    public void click()
    {
        ...
        if(x_move==2||x_move==3||x_move==4||x_move==7||x_move==11||x_move==14||x_move==15||x_move==16||x_move==17||x_move==19||x_move==21)
        {
            if(count<3) {
                count = count + 1;
                text_cont.setText(String.valueOf(count));
            }else {
                Toast.makeText(Night.this, "finish.", Toast.LENGTH_SHORT).show();
                text_cont.setText("1");
            }
        }
        else if(x_move==8) {
        ...
        else if(x_move==20)
        {
            ...
            if(count==1)
            {
                ...
                Toast.makeText(Night.this, "انتهى هنا", Toast.LENGTH_SHORT).show();
                text_cont.setText("1");
